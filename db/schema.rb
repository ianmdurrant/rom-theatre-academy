...
ActiveRecord::Schema.define(version: 2019_04_26_055548) do
  ...
  create_table "spina_article_parts", force: :cascade do |t|
  ...
  create_table "spina_articles", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "image_id"
    t.index ["image_id"], name: "index_spina_articles_on_image_id"
  end
  ...
  create_table "spina_project_categories", force: :cascade do |t|
    t.string "name"
    t.string "slug"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spina_projects", force: :cascade do |t|
    t.string "title"
    t.string "slug"
    t.text "description"
    t.string "lat"
    ...
    t.bigint "image_id"
    t.bigint "image_collection_id"
    t.integer "project_category_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["image_collection_id"], name: "index_spina_projects_on_image_collection_id"
    t.index ["image_id"], name: "index_spina_projects_on_image_id"
  end
  ...
  add_foreign_key "spina_articles", "spina_images", column: "image_id"
  add_foreign_key "spina_projects", "spina_image_collections", column: "image_collection_id"
  add_foreign_key "spina_projects", "spina_images", column: "image_id"
end
