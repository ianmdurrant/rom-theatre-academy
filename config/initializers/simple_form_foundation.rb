...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'grid-x grid-x-padding', hint_class: :field_with_hint, error_class: :error, valid_class: :valid do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    ...
    b.wrapper :label_wrapper, tag: :div, class: 'small-3 cell' do |ba|
      ba.use :label, class: 'text-right inline'
    end

    b.wrapper :right_input_wrapper, tag: :div, class: 'small-9 cell' do |ba|
      ba.use :input
